...
UPLOAD_FOLDER = r'F:\UPES\7th Semester\Major - 1\scale-safe-error-server\scalesafe\backend\uploads'
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER
os.makedirs(UPLOAD_FOLDER, exist_ok=True)  # Ensure the folder exists

# Set JSON file path for storing file metadata
JSON_FILE_PATH = r'F:\UPES\7th Semester\Major - 1\scale-safe-error-server\scalesafe\backend\file_metadata.json'
